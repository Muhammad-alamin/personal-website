...
<a href="index3.html" class="brand-link">
    ...
    <span class="brand-text font-weight-light">Personal Website</span>
</a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{route('portfolio.create')}}" class="nav-link @if(request()->routeIs('portfolio.create')) active @endif">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Create Portfolio</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{route('portfolio.index')}}" class="nav-link @if(request()->routeIs('portfolio.index')) active @endIf">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Portfolio List</p>
                        </a>
                    </li>
